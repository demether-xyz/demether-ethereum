...
import "@eigenlayer/test/utils/Operators.sol";

import "@eigenlayer/test/mocks/LiquidStakingToken.sol";
...
contract TestSetupEigenLayer is Test {
    ...
    function setUp() public virtual {
        acct_0 = vm.addr(uint256(priv_key_0));
        acct_1 = vm.addr(uint256(priv_key_1));
